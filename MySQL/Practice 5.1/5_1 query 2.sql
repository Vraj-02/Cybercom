...
('Vraj Patel', 'vraj@example.com'),
('Ved Patel', 'ved@example.com'),
('Aastha Patel', 'aastha@example.com');
...
JOIN orders_task2 o ON o.employee_id = e.id
JOIN order_details_task2 od  ON od.order_id = o.order_id
GROUP BY e.id
